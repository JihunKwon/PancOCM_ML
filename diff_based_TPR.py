...
for fidx in range(0, np.size(sr_list)):
    ...
    with open(f_name, mode='w',newline='') as file:
        ...
        writer.writerow(['TNR,FPR_train:', '{:.3f}'.format((bh*bh_test - outside_train_cnt[0]) / (bh*bh_test)), '{:.3f}'.format(outside_train_cnt[0] / (bh*bh_test)),
                             '{:.3f}'.format((bh*bh_test - outside_train_cnt[1]) / (bh*bh_test)), '{:.3f}'.format(outside_train_cnt[1] / (bh*bh_test)),
                             '{:.3f}'.format((bh*bh_test - outside_train_cnt[2]) / (bh*bh_test)), '{:.3f}'.format(outside_train_cnt[2] / (bh*bh_test))])
